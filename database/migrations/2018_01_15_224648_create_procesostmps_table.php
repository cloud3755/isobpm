...
class CreateProcesostmpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('procesostmps', function (Blueprint $table) {
          $table->increments('id');
          ...
          $table->integer('procesoOrigen')->nullable();

                        ...
                        <tr>
                          ...
                          <td>
                            <form class="" action="/productos/destroy/{{ $productos->id }}" method="post">
                              ...
                              <button type="button" class="btnobjetivo" data-toggle="modal" data-target="#modaledit<?=$productos['id']?>"><i class="glyphicon glyphicon-pencil"></i> Editar  </button>
                            </form>
                          </td>
                        </tr>
                        <?php endforeach ?>
          ...
          <form class="" action="/productos/store" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <button type="submit" class="btnobjetivo" id="btnobjetivo" style="font-family: Arial;">Subir registro</button>
            </form>
                  ...
                  <div class="container">
                    ...
                    <div class="form-group form-group-lg">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btnobjetivo" id="btnaltaindicador" style="font-family: Arial;">Editar Registro</button>
                    </form>

...
<form id="fileinfo" method="post">
	<input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
			<input type="hidden" name="tipo" value="six sigma">
			<div class="row" id="descripcion">
				<div class="col-md-12" id="titulo"><center>PROYECTO SIX SIGMA</center></div>
			</div>

			<div class="row" id="primero">
				<div class="col-md-3" id="fecha">Proyecto</div>
				<div class="col-md-9" id="datofecha">
			    <input class="form-control" type="text" name="proyecto" placeholder="Nombre de proyecto" required="">
			  </div>
			</div>

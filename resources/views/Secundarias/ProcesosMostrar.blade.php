                                                    ...
                                                    <tbody id = "myTable">
                                                      <?php foreach ($sipoc as $sipocs): ?>
                                                          <tr onclick="Editar(<?=$sipocs->id?>);" >
                                                              <td> <textarea class = "boxsizingBorder" name="name" rows="4" cols="25"><?=$sipocs->S?></textarea>
                                                                  </td>
                                                              <td><textarea class = "boxsizingBorder" name="name" rows="4" cols="25"><?=$sipocs->I?></textarea></td>
                                                              <td><textarea class = "boxsizingBorder" name="name" rows="4" cols="25"><?=$sipocs->P?></textarea></td>
                                                              <td><textarea class = "boxsizingBorder" name="name" rows="4" cols="25"><?=$sipocs->O?></textarea></td>
                                                              <td><textarea class = "boxsizingBorder" name="name" rows="4" cols="25"><?=$sipocs->C?></textarea></td>

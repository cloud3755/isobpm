...
<br><br><br><br><br>
                ...
                <div class="dataTable_wrapper">
                    <table width="100%" class="table table-responsive table-striped table-bordered table-hover" id="tblProIn">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>  <?=$proyects['nombre']?></td>
                          <td>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modaledit<?=$proyects['id']?>"><i class="glyphicon glyphicon-edit"></i> </button>
                          </td>
                          <td>
    ...
    <div class="modal fade" id="modalUpload" tabindex="-1" role="dialog" style="background-color:gray">
        ...
        <div class="container">
          <form class="" action="/proyectos/store" method="post">
    ...
    <?php foreach ($proyect as $proyects): ?>
    <div class="modal fade" id="modaledit<?=$proyects['id']?>" tabindex="-1" role="dialog" style="background-color:gray">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                  <div class="container">
                    <form  action="/proyectos/edit/<?=$proyects['id']?>" method="post">
                      <input type="hidden" name="_token" value="{{ csrf_token()}}">
                      <div class="form-group form-group-lg">
                        <h2><label for="Usuario" class="control-label col-md-12">Nombre:</label></h2>
                        <div class="col-md-6">
                            <input class="form-control input-lg" id="nombre" type="Text" value = "<?=$proyects['nombre']?>" placeholder="Nombre" name="nombre" required>
                        </div>
                      </div>
                    </div>
                        <div class="modal-footer">

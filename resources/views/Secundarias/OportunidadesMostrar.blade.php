                        ...
                        <tbody id = "myTable">
                            <?php foreach ($Oportunidad2 as $Oportunidades2): ?>
                                <tr>
                                    ...
                                    <td>
                                      <button type="button" class="btn btn-primary" value = "<?=$Oportunidades2->id?>" data-toggle="modal" data-target="#modaledit" onclick="Editar(this);"><i class="glyphicon glyphicon-edit"></i></button>
                                    </td>
                                    <td>
                                    <form class="" action="/analisisopor/destroy/{{ $Oportunidades2->id }}" method="post">
                                      ...
                                      return confirm('seguro de eliminar la oportunidad {{$Oportunidades2->actividad}}?')"><i class="fa fa-trash"></i></button>
                                    </form>
                                    </td>
                                </tr>
                            <?php endforeach ?>
